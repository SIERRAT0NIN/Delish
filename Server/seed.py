...
def seed_database():
    ...
    with app.app_context():
        ...
        post1 = Post(author=user1, title="Alice's First Post", content="Content of the first post by Alice", ingredients="List of ingredients by Alice", image_url="https://images.unsplash.com/photo-1501959915551-4e8d30928317?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
        ...
        post3 = Post(author=user3, title="Bob's First Post", content="Content of the first post by Bob", ingredients="List of ingredients by Alberto", image_url="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?q=80&w=1681&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")
